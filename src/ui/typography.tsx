...
export function TypographyH2({ text = "The People of the Kingdom" }: { text?: string }) {
  return (
    <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0 border-none text-center capitalize">
      {text}
    </h2>
  );
}
